...
final class PromptCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['name' => 'pideinfo-resolution-outcome-tiebreak', 'commitMessage' => 'Second turn: the analysis contradicted itself on the outcome; the fallo decides'],
            ['name' => 'pideinfo-resolution-extract-noncomplete', 'commitMessage' => 'Backfill analysis for resolutions missing fields'],
            ['name' => 'pideinfo-judgment-extract-analysis', 'commitMessage' => 'Judgment analysis: outcome/effect/stance triad, doctrine, ECLI'],
