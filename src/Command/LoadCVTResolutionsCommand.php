...
class LoadCVTResolutionsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($input->getOption('missing-pdf')) {
            return $this->processMissingPdfs(Resolution::SOURCE_CVT, $async, $skipAnalysis, $skipVectors, $limit, $io, $vision);
        }
        ...
        $io->section('Streaming resolutions from CVT website...');
        ...
        foreach ($this->cvtReader->streamPages($limit, fn (string $msg) => $io->text($msg)) as $pageDtos) {
